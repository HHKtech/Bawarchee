...
This repository currently implements **Phase 1 / Module 1: Auth Module** only.
...
`GOOGLE_GENERATIVE_AI_API_KEY` is included now because later modules use Gemini 1.5 Flash, but Module 1 does not call Gemini.
...
- `public.profiles`
- Row Level Security policies for user-owned profile access
...
2. Profile & Family Setup Module — next
3. Item Catalog & Search Module
4. Inventory Module
