...
import { loginWithPassword, signInWithGoogle, type AuthActionState } from '@/app/auth/actions';
  ...
  return (
    <div className="w-full max-w-md rounded-3xl border border-white/80 bg-white/90 p-8 shadow-xl shadow-amber-100 backdrop-blur">
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-amber-600">Welcome back</p>
        <h1 className="mt-3 text-3xl font-bold text-gray-950">Sign in to Bawarchee</h1>
        <p className="mt-2 text-sm text-gray-600">Continue managing your pantry and recipe plans.</p>
      </div>
