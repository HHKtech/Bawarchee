  ...
  return (
    <section className="flex h-full min-h-[520px] flex-col rounded-3xl border border-amber-100 bg-white p-6 shadow-sm">
      <div className="border-b border-amber-100 pb-5">
        ...
        <h2 className="mt-1 text-2xl font-bold text-gray-950 font-sans">Generated Recipes</h2>
      ...
      <div className="mt-6 flex flex-1 flex-col gap-6 overflow-y-auto">
        {isGeneratingRecipes ? (
          ...
          <div className="flex flex-1 flex-col justify-center py-10 text-center">
            ...
            <div className="mt-8 space-y-4 px-4 text-left">
              {[1, 2].map((i) => (
          ...
          <div className="flex flex-1 flex-col items-center justify-center rounded-3xl border border-dashed border-orange-200 bg-orange-50/60 p-8 text-center">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-950">No recipes generated yet</h3>
